...
# ==============================================================================
"""Resnet.
This is a fork of the resnet in Haiku, with some changes to that it is consistent
with the torchvision.resnet* models.
"""
...
class BlockV2(hk.Module):
    ...
    def __init__(
        ...
        conv_0 = hk.Conv2D(
            ...
            with_bias=False,
            padding="SAME" if bottleneck else ((1, 1), (1, 1)),
            name="conv_0",
        )
